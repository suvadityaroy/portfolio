...
const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'CyberArk PAM/EPM', icon: <Shield className="w-4 h-4 text-cyan-400" /> },
      { name: 'IAM', icon: <Shield className="w-4 h-4 text-green-500" /> },
      { name: 'Wiz CSPM', icon: <Shield className="w-4 h-4 text-sky-400" /> },
      { name: 'Splunk SIEM', icon: <Shield className="w-4 h-4 text-indigo-500" /> },
    ],
  },
  {
...
const enterpriseTools = [
  ...
  'Splunk SIEM', 'AWS Security Hub', 'DigiCert',
  'Proofpoint', 'Veracode SAST',
];
          ...
          {skills.map((group, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{
                  y: -4, scale: 1.01, rotateX: -6, rotateY: 6,
                  transition: { type: 'spring' as const, stiffness: 280, damping: 35, ease: 'easeOut' },
                }}
