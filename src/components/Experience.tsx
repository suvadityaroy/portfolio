...
const experiences: ExperienceItem[] = [
  {
    ...
    current: true,
    description: [
      'Supported security operations across 300+ enterprise cloud assets in AWS and Azure environments.',
      'Performed vulnerability assessment, triage, remediation tracking, and risk prioritization using Wiz and Qualys.',
      'Assisted privileged access management and endpoint security controls through CyberArk PAM/EPM.',
      'Monitored SIEM alerts, investigated suspicious activity, and supported incident response workflows.',
      'Contributed to IAM governance including access reviews and least-privilege controls.',
      'Automated recurring operational tasks and reporting processes using Python and scripts.',
    ],
  },
  {
    ...
    current: false,
    description: [
      'Managed infrastructure operations across multi-system environments with focus on uptime, stability, and performance.',
      'Automated internal workflows and repetitive tasks using Python and Golang.',
      'Supported user access management, technical troubleshooting, and service reliability processes.',
      'Assisted patching, configuration hardening, and secure operational practices.',
      'Maintained and monitored systems across a 50+ node environment.',
    ],
  },
  {
    ...
    current: false,
    description: [
      'Assisted vulnerability assessments and security testing across internal systems.',
      'Supported security monitoring, log review, and basic incident analysis tasks.',
      'Contributed to remediation documentation and security recommendations.',
      'Built practical understanding of cybersecurity operations, controls, and risk management.',
    ],
  },
  {
    ...
    current: false,
    description: [
      'Completed cybersecurity consulting simulation based on enterprise security scenarios.',
      'Performed application security reviews aligned to OWASP Top 10 practices.',
      'Applied STRIDE threat modeling to identify risks and recommend mitigations.',
      'Documented findings with CVSS-based prioritization and remediation guidance.',
    ],
  },
];
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className={`mx-auto max-w-2xl text-sm md:text-base leading-7 ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
            A growth-focused security engineer with hands-on experience in cloud compliance, automation, vulnerability management, and production SOC operations.
          </p>
          <motion.div
            className={`h-1 mx-auto mt-8 rounded-full ${divider}`}
            initial={{ width: 0 }}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative pl-14" aria-label="Experience timeline">

            {/* Animated timeline line that draws down */}
            <motion.div
              className={`absolute left-5 top-0 w-0.5 rounded-full origin-top ${
                isDark
                  ? 'bg-gradient-to-b from-sky-500/80 via-indigo-500/45 to-transparent'
                  : 'bg-gradient-to-b from-indigo-400/70 via-violet-300/35 to-transparent'
              }`}
              initial={{ scaleY: 0 }}
                ...
                >
                  ...
                  <motion.div
                    whileHover={{
                      ...
                      transition: { type: 'spring' as const, stiffness: 300, damping: 35, ease: 'easeOut' },
                    }}
